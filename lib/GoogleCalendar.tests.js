...
describe('[class] GoogleCalendar', () => {
  ...
  beforeEach(() => {
    token = {
      access_token: 'ya29.GlvlBl0RsTtU8uZNOI5P5ErrGPVm5OXB9YfgScGANfBaIxj5qAhYC5N1QPWpWyqzagy4neR3kRBLM6Vxd2fdU0KppVOZSMBbn1i2snGg9Xj_kxRGjTRHDSAWvsrB',
  ...
  describe('[method] getMinDate', () => {
    it('should throw an error if unrecorgnized type', () => {
      try {
        GoogleCalendar.getMinDate('bogus');
      } catch (error) {
  ...
  describe('[method] findLastEventDate', () => {
    ...
    it('should return the date of the most recent prior event found', () => {
      ...
      const dateTime2 = moment().add(2, 'week').toISOString();
